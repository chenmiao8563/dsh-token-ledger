 ...
 * @param {{ ledgerPath?: string, backfill?: boolean, rates?: boolean|object }} [config] - composition config. `rates: false` disables the pricing feature's networking entirely, leaving hand-entered values as the only source, which is the setting a strictly offline host wants. `rates.vendors` caps how many vendors are published (`0` for all of them).
 * @returns {void}
 */
