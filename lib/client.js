...
.tl-bill-head, .tl-bill-row, .tl-bill-total { display: grid; grid-template-columns: minmax(150px, 1fr) 108px 96px 88px 88px 76px 62px; align-items: center; gap: 8px; font-size: 12px; }
